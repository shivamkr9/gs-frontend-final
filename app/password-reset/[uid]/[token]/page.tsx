import { ResetPassConfirm } from "@/components/forms";
import Image from "next/image";
import type { Metadata } from 'next';

export const metadata: Metadata = {
    title: `${process.env.APP_NAME} | Password Reset Confirm`,
    description: `${process.env.APP_NAME} password reset confirm page`,
};
                ...
                <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
                    ...
                    <div className='w-full bg-foreground/5 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 '>
                        <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
                            ...
                            <ResetPassConfirm uid={uid} token={token} />
                        </div>
                    </div>
                </div>
            </div>
